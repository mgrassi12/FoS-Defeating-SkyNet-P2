...
# Project question...
# Is this the best choice of prime (1536)? Why? Why not? Feel free to replace!
# No. The prime should be large enough to at least defend
# against the already known attacks and then some. It is speculated
# that the NSA have already cracked some widely used 1024 bit primes.
...
# xa (our secret key), ya (our public key), yb (their public key) etc.
